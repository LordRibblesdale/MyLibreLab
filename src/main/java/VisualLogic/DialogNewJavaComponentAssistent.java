...
public class DialogNewJavaComponentAssistent extends javax.swing.JDialog implements ElementPaletteIF {
    ...
    public DialogNewJavaComponentAssistent(FrameMain frameCircuit, boolean modal) {
        ...
        col1.setHeaderValue(
                java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent").getString("Name"));

        TableColumn col2 = modCol.getColumn(1);
        col2.setHeaderValue(java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent")
                .getString("DataType"));

        TableColumn col3 = modCol.getColumn(2);
        col3.setHeaderValue(java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent")
                .getString("Min(Only Numerik)"));

        TableColumn col4 = modCol.getColumn(3);
        col4.setHeaderValue(java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent")
                .getString("Max(Only Numerik)"));
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle =
                java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent"); // NOI18N
                ...
                .addGroup(jPanel3Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel3Layout.createSequentialGroup().addComponent(jLabel5)
                                        ...
                                        .addComponent(txtName, javax.swing.GroupLayout.PREFERRED_SIZE, 202,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel3Layout.createSequentialGroup().addComponent(jRadioButton1)
                                        .addGap(11, 11, 11).addComponent(jRadioButton2)))
                        .addContainerGap()));
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(jLabel5).addComponent(txtName, javax.swing.GroupLayout.PREFERRED_SIZE,
        ...
        jPanel7Layout.setHorizontalGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel7Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jCheckBox3).addComponent(jCheckBox5).addComponent(jCheckBox6)
                                .addComponent(jCheckBox4))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel7Layout.createSequentialGroup().addContainerGap().addComponent(jCheckBox3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jCheckBox5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jCheckBox4, javax.swing.GroupLayout.PREFERRED_SIZE, 15,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jCheckBox6)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        ...
        jPanel11Layout.setHorizontalGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel11Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel11Layout.createSequentialGroup().addComponent(jLabel7)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jSpinner5, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel12Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel12Layout.createSequentialGroup().addComponent(jLabel8)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jSpinner6, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel13Layout.setHorizontalGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel13Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel13Layout.createSequentialGroup().addComponent(jLabel9)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jSpinner7, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addComponent(jCheckBox1)
        ...
        jTable8.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {{"", null, null, null},
                ...
                {null, null, null, null}, {null, null, null, null}, {null, null, null, null}, {null, null, null, null},
                {null, null, null, null}},
                new String[] {"itemName", "Datatype", "Min (only Numerik)", "Max (only Numerik)"}) {
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel3).addComponent(jScrollPane5,
        ...
        layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup().addContainerGap()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTabbedPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 428,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    {// GEN-HEADEREND:event_jButton4ActionPerformed
        ...
        chooser.setDialogTitle(java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent")
    ...
    {// GEN-HEADEREND:event_jButton3ActionPerformed
        ...
        chooser.addChoosableFileFilter(new javax.swing.filechooser.FileFilter() {
            ...
            public String getDescription() {
                return java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent")
                        .getString("JavaElement_Settings_Data_(javaelementconfig)");
            }
        });
...
>>>>>>> upstream/master
    ...
    {// GEN-HEADEREND:event_jButton2ActionPerformed
        ...
        if (compName.length() == 0) {
            Tools.showMessage(this,
                    java.util.ResourceBundle.getBundle("VisualLogic/Messages").getString("Name is recommended"));
            return;
        }
        ...
        if (new File(str).exists()) {
            ...
            Tools.showMessage(this, java.util.ResourceBundle.getBundle("VisualLogic/DialogNewJavaComponentAssistent")
                    .getString("Directory_already_exists") + " : " + compName);
            return;
        }

        saveSettings();
        /*
         * String filename="c:\\test.config"; saveConfiFile(new File(filename));
         */
        result = true;
        setVisible(false);
            ...
            for (int pc = 0; pc < settings.pins.size(); pc++) {
                ...
                for (int i = 0; i < ps.items.size(); i++) {
                    ...
                    if (item.io.equalsIgnoreCase(ioX)) {
                        ...
                        out.write("  " + vsType + " " + ioX + c + " = new " + vsObject + ";");
                        out.newLine();
                        c++;
                    }
                }
        ...
        try {
            ...
            for (int pc = 0; pc < settings.pins.size(); pc++) {
                ...
                for (int i = 0; i < ps.items.size(); i++) {
                    ...
                    out.write("    setPin(" + c + ", ExternalIF." + item.dt + ", ExternalIF." + strIO + ");");
                    out.newLine();
                    c++;
                }
            }
            ...
            for (int pc = 0; pc < settings.pins.size(); pc++) {
                ...
                for (int i = 0; i < ps.items.size(); i++) {
                    ...
                    out.write("    element.jSetPinDescription(" + c + ", \"" + item.name + "\");");
                    out.newLine();
                    c++;
                }
            }
        ...
        try {
            ...
            for (int i = 0; i < settings.properties.size(); i++) {
                ...
                if (item.name.length() > 0) {
                    out.write("  " + vsType + " prop" + item.name + " = new " + vsObject + ";");
                    out.newLine();
                }
            }
        } catch (Exception ex) {
        ...
        try {
            for (int i = 0; i < settings.properties.size(); i++) {
                ...
                if (item.name.length() > 0) {
                    ...
                    out.write("    element.jAddPEItem(\"" + item.name + "\", prop" + item.name + ", " + item.min + ", "
                            + item.max + ");");
                    out.newLine();
                }
            }
    ...
    public void createsetPropertyEditorItemsLocalized(BufferedWriter out) {
        try {
            for (int i = 0; i < settings.properties.size(); i++) {
                ...
                if (item.name.length() > 0) {
                    out.write("    element.jSetPEItemLocale(d+" + i + ", language,\"" + item.name + "\");");
                    out.newLine();
                }
            }
        } catch (Exception ex) {
        ...
        try {
            ...
            for (int pc = 0; pc < settings.pins.size(); pc++) {
                ...
                for (int i = 0; i < ps.items.size(); i++) {
                    ...
                    if (item.io.equalsIgnoreCase("input")) {
                        String vsType = VSDataType.getPinDataType(item.intDT);
                        out.write("    input" + cc + "= (" + vsType + ")element.getPinInputReference(" + c + ");");
                        out.newLine();
                        cc++;
                    }
                    c++;
            ...
            for (int pc = 0; pc < settings.pins.size(); pc++) {
                ...
                for (int i = 0; i < ps.items.size(); i++) {
                    ...
                    if (item.io.equalsIgnoreCase("output")) {
                        ...
                        out.write("    element.setPinOutputReference(" + c + ", output" + cc + ");");
                        out.newLine();
                        cc++;
                    }
                    c++;
    ...
    public void generateDefinitionDef(String destPath, int type) {
        try {
            ...
            out.write("ISDIRECTORY  = FALSE");
            out.newLine();
            out.write("CAPTION      = DE_" + elementName);
            out.newLine();
            out.write("CAPTION_EN   = EN_" + elementName);
            out.newLine();
            out.write("CAPTION_ES   = ES_" + elementName);
            out.newLine();
            out.write("ClassCircuit = " + settings.circuitPanelName);
            out.newLine();
            if (type == 1) {
                out.write("ClassFront   = " + settings.frontPanelName);
                out.newLine();
            }
    ...
    public void generateCircuitJavaFile(String basisDestPath, String srcPath, int type) {
        try {
            ...
            out.newLine();
            out.write("import tools.*;");
            out.newLine();
            out.write("import VisualLogic.variables.*;");
            out.newLine();
            out.write("");
            out.newLine();

            out.write("public class " + settings.circuitPanelName + " extends JVSMain");
            out.newLine();
            out.write("{");
            out.newLine();
            ...
            {
                out.write("private ExternalIF panelElement;");
                out.newLine();
            }

            out.write("  private Image image;");
            out.newLine();
            ...
            out.write("  public void onDispose()");
            out.newLine();
            out.write("  {");
            out.newLine();
            out.write("    if (image!=null) image.flush();");
            out.newLine();
            out.write("    image=null;");
            out.newLine();
            out.write("  }");
            out.newLine();
            out.newLine();

            out.write("  public void paint(java.awt.Graphics g)");
            out.newLine();
            out.write("  {");
            out.newLine();
            out.write("    if (image!=null) drawImageCentred(g,image);");
            out.newLine();
            out.write("  }");
            out.newLine();
            out.newLine();

            out.write("  public void setPropertyEditor()");
            out.newLine();
            out.write("  {");
            out.newLine();
            ...
            out.write("  private void localize()");
            out.newLine();
            out.write("  {");
            out.newLine();
            out.write("    String language;");
            out.newLine();
            out.write("    int d=6;");
            out.newLine();
            out.write("    language=\"en_US\";");
            out.newLine();
            createsetPropertyEditorItemsLocalized(out);
            out.write("    ");
            out.newLine();
            out.write("    language=\"es_ES\";");
            out.newLine();
            createsetPropertyEditorItemsLocalized(out);
            out.write("  }");
            out.newLine();
            ...
            if (type == 1) // PanelElement
            {
                out.write("    panelElement=element.getPanelElement();");
                out.newLine();
            }
            out.write("  }");
            out.newLine();
            ...
            if (settings.pins.size() == 4) {
                ...
                out.write("    initPins(" + pinsTop + "," + pinsRight + "," + pinsBottom + "," + pinsLeft + ");");
                out.newLine();
                out.write("    initPinVisibility(" + pinsTopVisible + "," + pinsRightVisible + "," + pinsBottomVisible
                        + "," + pinsLeftVisible + ");");
                out.newLine();
            } else {
                out.write("    initPins(0,0,0,0);");
                out.newLine();
            }
            int w = 0;
            int h = 0;
            ...
            out.write("    setSize(30+" + w + ",30+" + h + ");");
            out.newLine();
            out.write("    image=element.jLoadImage(element.jGetSourcePath()+\"image.gif\");");
            out.newLine();
            ...
            out.write("");
            out.newLine();
            out.write("    element.jSetResizable(" + strBol + ");");
            out.newLine();
            strBol = "" + settings.circuitElementResizableWithAspect;
            out.write("    element.jSetResizeSynchron(" + strBol + ");");
            out.newLine();
            ...
            out.write("  public void initInputPins()");
            out.newLine();
            out.write("  {");
            out.newLine();
            ...
            out.write("  public void initOutputPins()");
            out.newLine();
            out.write("  {");
            out.newLine();
            ...
            out.write("  public void elementActionPerformed(ElementActionEvent evt)");
            out.newLine();
            out.write("  {");
            out.newLine();
            out.write("    int idx=evt.getSourcePinIndex();");
            out.newLine();
            out.write("    switch (idx)");
            out.newLine();
            out.write("    {");
            out.newLine();
            out.write("      //case 0: DoSomething(); break;");
            out.newLine();
            out.write("    }");
            out.newLine();
            out.write("  }");
            ...
            out.write("  public void loadFromStream(java.io.FileInputStream fis)");
            out.newLine();
            out.write("  {");
            out.newLine();
            out.write("  //xxx.loadFromStream(fis);");
            out.newLine();
            out.write("  }");
            out.newLine();
            out.newLine();

            out.write("  public void saveToStream(java.io.FileOutputStream fos)");
            out.newLine();
            out.write("  {");
            out.newLine();
            out.write("  //xxx.saveToStream(fos);");
            out.newLine();
            out.write("  }");
            out.newLine();
            out.newLine();
    ...
    public void generateFrontJavaFile(String basisDestPath, String srcPath) {
        ...
        try {
            ...
            out.write("public class " + settings.frontPanelName + " extends JVSMain implements PanelIF ");
            out.newLine();
            out.write("{");
            out.newLine();

            out.write("private ExternalIF circuitElement;");
            out.newLine();
            ...
            out.write("  public void processPanel(int pinIndex, double value, Object obj)");
            out.newLine();
            out.write("  {");
            out.newLine();
            out.write("    //if (value==0.0) setOn(false); else setOn(true);");
            out.newLine();
            out.write("  }");
            out.newLine();
            ...
            out.write("    circuitElement=element.getCircuitElement();");
            out.newLine();
            out.write("  }");
            out.newLine();
            ...
            out.write("    initPins(0,0,0,0);");
            out.newLine();
            out.write("    setSize(50,50);");
            out.newLine();
            out.write("    initPinVisibility(false,false,false,false);");
            out.newLine();
            out.write("");
            out.newLine();
